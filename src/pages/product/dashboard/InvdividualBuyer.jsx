...
import {
  BuyerBarChartIndividual,
  DeliveriesPieChart,
  WeeklyDeliveryChart,
} from "../../../components/summary/Summary";

import PieChart from "../../../components/PieChart";
import IndividualAnalytics from "../../../components/summary/IndividualAnalytics";

const InvdividualBuyer = () => {
  ...
  const [orders, setOrders] = useState([]);
     ...
     }, [individualId]); // Re-run when `farmerId` changes
     ...
     const fetchOrders = async () => {
       ...
       try {
         const response = await fetch(`https://spida.africa/individual/get_order_individual_dashboard.php?individual_id=${individualId}`);
...
export default InvdividualBuyer;
