      ...
      <div className="trk-shell">
        <header className="trk-head">
          ...
          <div className="trk-actions">
            <button className="trk-btnGhost" type="button" onClick={() => setCurrentStep((s) => Math.max(0, s - 1))}>◀ Prev</button>
            <button className="trk-btnGhost" type="button" onClick={() => setCurrentStep((s) => Math.min(steps.length - 1, s + 1))}>Next ▶</button>
          </div>
        </header>
          ...
          <div className="trk-card">
            ...
            <div className="trk-timeline">
              {steps.map((s, idx) => {
                ...
                return (
                  <div key={s.key} className={`trk-step ${done ? "done" : ""} ${active ? "active" : ""}`}>
          ...
          <div className="trk-card trk-right">
            ...
            <div className="trk-statusBox">
              ...
              {steps[currentStep].key === "enroute" && (
                <div className="trk-mini">Estimated arrival: <b>{meta.etaMinutes} mins</b></div>
              )}
            </div>
