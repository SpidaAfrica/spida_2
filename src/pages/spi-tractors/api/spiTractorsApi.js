...
export const spiTractorsApi = {
  ...
  health: () => request("/health.php"),myNotifications: () => request("/notification_me.php", { auth: true }),
...
paystackVerify: async (reference) => {
  ...
  getTractorLocation: (tractorId) =>
    request(`/tractor_location.php?tractor_id=${tractorId}`, { auth: true }),
